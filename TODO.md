...
* maybe movies playing should be considered as a kind of stream playing (see streams.go) and have a parallel API. It would be great if they can return input events. Yet, I think we may want the capacitry to pause the movie, rewind it, ... This is not what stresm do. To be discussed.
