...
> **Note on SDL3:** `goxpyriment` uses `github.com/Zyko0/go-sdl3` which embeds pre-built SDL3 and SDL3_ttf shared libraries directly in the Go binary. **You do not need to install SDL3 system-wide.** The only prerequisite is Go 1.25+.
...
> Note: SDL3 and SDL3_ttf are embedded in the Go binary via `github.com/Zyko0/go-sdl3/bin/binsdl` and `binttf`. No system-wide SDL3 installation is required.
