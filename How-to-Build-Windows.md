...
> **Note on SDL3:** `goxpyriment` uses `github.com/Zyko0/go-sdl3` which embeds pre-built SDL3 and SDL3_ttf DLLs directly in the Go binary for both amd64 and arm64. **You do not need to install or distribute SDL3 separately.** The only prerequisite is Go 1.25+.
